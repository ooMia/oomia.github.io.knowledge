...
설계 정의 자체가 Outcome인 Item은 해당 canonical 문서의 **immutable commit/permalink**를 Evidence로 사용할 수 있다. 예를 들어 `Publishing Platform 1.0 Definition`은 [Release 1.0](docs/release-1.0.md), `Project Planning Model`은 [Planning Model](docs/planning-model.md)의 확정 revision을 가리킨다.
